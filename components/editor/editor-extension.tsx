...
import { EditorFacebookEmbed } from "./editor-facebook-embed"
import { EditorXEmbed } from "./editor-x-embed"
...
export const EditorExtension = Extension.create<EditorExtensionOptions>({
  ...
  addExtensions() {
    ...
    extensions.push(EditorCommandMenu)
    extensions.push(
      Table.configure({
        resizable: true,
      }),
    ...
    extensions.push(EditorButton)
    extensions.push(EditorXEmbed)
    extensions.push(
      Focus.configure({
        className: "has-focus",
        mode: "shallowest",
    ...
    extensions.push(EditorFacebookEmbed)
